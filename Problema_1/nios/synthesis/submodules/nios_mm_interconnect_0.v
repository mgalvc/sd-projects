...
module nios_mm_interconnect_0 (
	...
	wire   [6:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> memory_s1_agent:cp_channel
	...
	wire   [6:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> buttons_s1_agent:cp_channel
	...
	wire  [90:0] lcd_rw_s1_agent_rf_source_data;                                              // LCD_RW_s1_agent:rf_source_data -> LCD_RW_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] lcd_rw_s1_agent_rsp_fifo_out_data;                                           // LCD_RW_s1_agent_rsp_fifo:out_data -> LCD_RW_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                       // cmd_mux_005:src_valid -> LCD_RW_s1_agent:cp_valid
	wire  [89:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> LCD_RW_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                       // LCD_RW_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> LCD_RW_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                               // cmd_mux_005:src_startofpacket -> LCD_RW_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                 // cmd_mux_005:src_endofpacket -> LCD_RW_s1_agent:cp_endofpacket
	...
	wire  [90:0] lcd_en_s1_agent_rf_source_data;                                              // LCD_EN_s1_agent:rf_source_data -> LCD_EN_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] lcd_en_s1_agent_rsp_fifo_out_data;                                           // LCD_EN_s1_agent_rsp_fifo:out_data -> LCD_EN_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                       // cmd_mux_006:src_valid -> LCD_EN_s1_agent:cp_valid
	wire  [89:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> LCD_EN_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                       // LCD_EN_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> LCD_EN_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                               // cmd_mux_006:src_startofpacket -> LCD_EN_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                 // cmd_mux_006:src_endofpacket -> LCD_EN_s1_agent:cp_endofpacket
	...
	wire         lcd_rw_s1_agent_rp_valid;                                                    // LCD_RW_s1_agent:rp_valid -> router_007:sink_valid
	wire  [89:0] lcd_rw_s1_agent_rp_data;                                                     // LCD_RW_s1_agent:rp_data -> router_007:sink_data
	wire         lcd_rw_s1_agent_rp_ready;                                                    // router_007:sink_ready -> LCD_RW_s1_agent:rp_ready
	wire         lcd_rw_s1_agent_rp_startofpacket;                                            // LCD_RW_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         lcd_rw_s1_agent_rp_endofpacket;                                              // LCD_RW_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         lcd_en_s1_agent_rp_valid;                                                    // LCD_EN_s1_agent:rp_valid -> router_008:sink_valid
	wire  [89:0] lcd_en_s1_agent_rp_data;                                                     // LCD_EN_s1_agent:rp_data -> router_008:sink_data
	wire         lcd_en_s1_agent_rp_ready;                                                    // router_008:sink_ready -> LCD_EN_s1_agent:rp_ready
	wire         lcd_en_s1_agent_rp_startofpacket;                                            // LCD_EN_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         lcd_en_s1_agent_rp_endofpacket;                                              // LCD_EN_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         lcd_rw_s1_agent_rdata_fifo_src_valid;                                        // LCD_RW_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] lcd_rw_s1_agent_rdata_fifo_src_data;                                         // LCD_RW_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         lcd_rw_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_005:in_0_ready -> LCD_RW_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                           // avalon_st_adapter_005:out_0_valid -> LCD_RW_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                            // avalon_st_adapter_005:out_0_data -> LCD_RW_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                           // LCD_RW_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                           // avalon_st_adapter_005:out_0_error -> LCD_RW_s1_agent:rdata_fifo_sink_error
	wire         lcd_en_s1_agent_rdata_fifo_src_valid;                                        // LCD_EN_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] lcd_en_s1_agent_rdata_fifo_src_data;                                         // LCD_EN_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         lcd_en_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_006:in_0_ready -> LCD_EN_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                           // avalon_st_adapter_006:out_0_valid -> LCD_EN_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                            // avalon_st_adapter_006:out_0_data -> LCD_EN_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                           // LCD_EN_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                           // avalon_st_adapter_006:out_0_error -> LCD_EN_s1_agent:rdata_fifo_sink_error
