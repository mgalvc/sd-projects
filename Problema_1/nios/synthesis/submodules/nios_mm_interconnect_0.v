...
module nios_mm_interconnect_0 (
	...
	wire         cmd_mux_005_src_valid;                                                       // cmd_mux_005:src_valid -> lcd_rs_s1_agent:cp_valid
	wire  [91:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> lcd_rs_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                       // lcd_rs_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [8:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> lcd_rs_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                               // cmd_mux_005:src_startofpacket -> lcd_rs_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                 // cmd_mux_005:src_endofpacket -> lcd_rs_s1_agent:cp_endofpacket
	...
	wire  [91:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> lcd_rw_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                       // lcd_rw_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [8:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> lcd_rw_s1_agent:cp_channel
	...
	wire         cmd_mux_007_src_valid;                                                       // cmd_mux_007:src_valid -> lcd_data_s1_agent:cp_valid
	wire  [91:0] cmd_mux_007_src_data;                                                        // cmd_mux_007:src_data -> lcd_data_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                       // lcd_data_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [8:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> lcd_data_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                               // cmd_mux_007:src_startofpacket -> lcd_data_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                 // cmd_mux_007:src_endofpacket -> lcd_data_s1_agent:cp_endofpacket
	...
	wire         lcd_rs_s1_agent_rp_valid;                                                    // lcd_rs_s1_agent:rp_valid -> router_007:sink_valid
	wire  [91:0] lcd_rs_s1_agent_rp_data;                                                     // lcd_rs_s1_agent:rp_data -> router_007:sink_data
	wire         lcd_rs_s1_agent_rp_ready;                                                    // router_007:sink_ready -> lcd_rs_s1_agent:rp_ready
	wire         lcd_rs_s1_agent_rp_startofpacket;                                            // lcd_rs_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         lcd_rs_s1_agent_rp_endofpacket;                                              // lcd_rs_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         lcd_rw_s1_agent_rp_valid;                                                    // lcd_rw_s1_agent:rp_valid -> router_008:sink_valid
	wire  [91:0] lcd_rw_s1_agent_rp_data;                                                     // lcd_rw_s1_agent:rp_data -> router_008:sink_data
	wire         lcd_rw_s1_agent_rp_ready;                                                    // router_008:sink_ready -> lcd_rw_s1_agent:rp_ready
	wire         lcd_rw_s1_agent_rp_startofpacket;                                            // lcd_rw_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         lcd_rw_s1_agent_rp_endofpacket;                                              // lcd_rw_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         lcd_data_s1_agent_rp_valid;                                                  // lcd_data_s1_agent:rp_valid -> router_009:sink_valid
	wire  [91:0] lcd_data_s1_agent_rp_data;                                                   // lcd_data_s1_agent:rp_data -> router_009:sink_data
	wire         lcd_data_s1_agent_rp_ready;                                                  // router_009:sink_ready -> lcd_data_s1_agent:rp_ready
	wire         lcd_data_s1_agent_rp_startofpacket;                                          // lcd_data_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         lcd_data_s1_agent_rp_endofpacket;                                            // lcd_data_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         lcd_rs_s1_agent_rdata_fifo_src_valid;                                        // lcd_rs_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] lcd_rs_s1_agent_rdata_fifo_src_data;                                         // lcd_rs_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         lcd_rs_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_005:in_0_ready -> lcd_rs_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                           // avalon_st_adapter_005:out_0_valid -> lcd_rs_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                            // avalon_st_adapter_005:out_0_data -> lcd_rs_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                           // lcd_rs_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                           // avalon_st_adapter_005:out_0_error -> lcd_rs_s1_agent:rdata_fifo_sink_error
	...
	wire         lcd_data_s1_agent_rdata_fifo_src_valid;                                      // lcd_data_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] lcd_data_s1_agent_rdata_fifo_src_data;                                       // lcd_data_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         lcd_data_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_007:in_0_ready -> lcd_data_s1_agent:rdata_fifo_src_ready
