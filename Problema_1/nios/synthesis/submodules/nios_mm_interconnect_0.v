...
module nios_mm_interconnect_0 (
	...
	wire   [8:0] cmd_mux_src_channel;                                                         // cmd_mux:src_channel -> nios2_debug_mem_slave_agent:cp_channel
	...
	wire  [14:0] lcd_en_s1_agent_m0_address;                                                  // LCD_EN_s1_agent:m0_address -> LCD_EN_s1_translator:uav_address
	...
	wire  [93:0] lcd_en_s1_agent_rf_source_data;                                              // LCD_EN_s1_agent:rf_source_data -> LCD_EN_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] lcd_en_s1_agent_rsp_fifo_out_data;                                           // LCD_EN_s1_agent_rsp_fifo:out_data -> LCD_EN_s1_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                       // cmd_mux_001:src_valid -> LCD_EN_s1_agent:cp_valid
	wire  [92:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> LCD_EN_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                       // LCD_EN_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [8:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> LCD_EN_s1_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                               // cmd_mux_001:src_startofpacket -> LCD_EN_s1_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                 // cmd_mux_001:src_endofpacket -> LCD_EN_s1_agent:cp_endofpacket
	...
	wire  [14:0] lcd_rw_s1_agent_m0_address;                                                  // LCD_RW_s1_agent:m0_address -> LCD_RW_s1_translator:uav_address
	...
	wire  [93:0] lcd_rw_s1_agent_rf_source_data;                                              // LCD_RW_s1_agent:rf_source_data -> LCD_RW_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] lcd_rw_s1_agent_rsp_fifo_out_data;                                           // LCD_RW_s1_agent_rsp_fifo:out_data -> LCD_RW_s1_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                       // cmd_mux_002:src_valid -> LCD_RW_s1_agent:cp_valid
	wire  [92:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> LCD_RW_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                       // LCD_RW_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [8:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> LCD_RW_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                               // cmd_mux_002:src_startofpacket -> LCD_RW_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                 // cmd_mux_002:src_endofpacket -> LCD_RW_s1_agent:cp_endofpacket
	...
	wire  [14:0] lcd_rs_s1_agent_m0_address;                                                  // LCD_RS_s1_agent:m0_address -> LCD_RS_s1_translator:uav_address
	...
	wire  [93:0] lcd_rs_s1_agent_rf_source_data;                                              // LCD_RS_s1_agent:rf_source_data -> LCD_RS_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] lcd_rs_s1_agent_rsp_fifo_out_data;                                           // LCD_RS_s1_agent_rsp_fifo:out_data -> LCD_RS_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                       // cmd_mux_003:src_valid -> LCD_RS_s1_agent:cp_valid
	wire  [92:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> LCD_RS_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                       // LCD_RS_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [8:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> LCD_RS_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                               // cmd_mux_003:src_startofpacket -> LCD_RS_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                 // cmd_mux_003:src_endofpacket -> LCD_RS_s1_agent:cp_endofpacket
	...
	wire  [14:0] lcd_data_s1_agent_m0_address;                                                // LCD_DATA_s1_agent:m0_address -> LCD_DATA_s1_translator:uav_address
	...
	wire  [93:0] lcd_data_s1_agent_rf_source_data;                                            // LCD_DATA_s1_agent:rf_source_data -> LCD_DATA_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] lcd_data_s1_agent_rsp_fifo_out_data;                                         // LCD_DATA_s1_agent_rsp_fifo:out_data -> LCD_DATA_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> LCD_DATA_s1_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> LCD_DATA_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                       // LCD_DATA_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [8:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> LCD_DATA_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> LCD_DATA_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> LCD_DATA_s1_agent:cp_endofpacket
	...
	wire   [8:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> leds_s1_agent:cp_channel
	...
	wire         cmd_mux_007_src_valid;                                                       // cmd_mux_007:src_valid -> memory_s1_agent:cp_valid
	wire  [92:0] cmd_mux_007_src_data;                                                        // cmd_mux_007:src_data -> memory_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                       // memory_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [8:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> memory_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                               // cmd_mux_007:src_startofpacket -> memory_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                 // cmd_mux_007:src_endofpacket -> memory_s1_agent:cp_endofpacket
	...
	wire  [92:0] cmd_mux_008_src_data;                                                        // cmd_mux_008:src_data -> uart_s1_agent:cp_data
	...
	wire         lcd_en_s1_agent_rp_valid;                                                    // LCD_EN_s1_agent:rp_valid -> router_003:sink_valid
	wire  [92:0] lcd_en_s1_agent_rp_data;                                                     // LCD_EN_s1_agent:rp_data -> router_003:sink_data
	wire         lcd_en_s1_agent_rp_ready;                                                    // router_003:sink_ready -> LCD_EN_s1_agent:rp_ready
	wire         lcd_en_s1_agent_rp_startofpacket;                                            // LCD_EN_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         lcd_en_s1_agent_rp_endofpacket;                                              // LCD_EN_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         lcd_rw_s1_agent_rp_valid;                                                    // LCD_RW_s1_agent:rp_valid -> router_004:sink_valid
	wire  [92:0] lcd_rw_s1_agent_rp_data;                                                     // LCD_RW_s1_agent:rp_data -> router_004:sink_data
	wire         lcd_rw_s1_agent_rp_ready;                                                    // router_004:sink_ready -> LCD_RW_s1_agent:rp_ready
	wire         lcd_rw_s1_agent_rp_startofpacket;                                            // LCD_RW_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         lcd_rw_s1_agent_rp_endofpacket;                                              // LCD_RW_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         lcd_rs_s1_agent_rp_valid;                                                    // LCD_RS_s1_agent:rp_valid -> router_005:sink_valid
	wire  [92:0] lcd_rs_s1_agent_rp_data;                                                     // LCD_RS_s1_agent:rp_data -> router_005:sink_data
	wire         lcd_rs_s1_agent_rp_ready;                                                    // router_005:sink_ready -> LCD_RS_s1_agent:rp_ready
	wire         lcd_rs_s1_agent_rp_startofpacket;                                            // LCD_RS_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         lcd_rs_s1_agent_rp_endofpacket;                                              // LCD_RS_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         lcd_data_s1_agent_rp_valid;                                                  // LCD_DATA_s1_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] lcd_data_s1_agent_rp_data;                                                   // LCD_DATA_s1_agent:rp_data -> router_006:sink_data
	wire         lcd_data_s1_agent_rp_ready;                                                  // router_006:sink_ready -> LCD_DATA_s1_agent:rp_ready
	wire         lcd_data_s1_agent_rp_startofpacket;                                          // LCD_DATA_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         lcd_data_s1_agent_rp_endofpacket;                                            // LCD_DATA_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         memory_s1_agent_rp_valid;                                                    // memory_s1_agent:rp_valid -> router_009:sink_valid
	wire  [92:0] memory_s1_agent_rp_data;                                                     // memory_s1_agent:rp_data -> router_009:sink_data
	wire         memory_s1_agent_rp_ready;                                                    // router_009:sink_ready -> memory_s1_agent:rp_ready
	wire         memory_s1_agent_rp_startofpacket;                                            // memory_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         memory_s1_agent_rp_endofpacket;                                              // memory_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [92:0] uart_s1_agent_rp_data;                                                       // uart_s1_agent:rp_data -> router_010:sink_data
	...
	wire         lcd_en_s1_agent_rdata_fifo_src_valid;                                        // LCD_EN_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] lcd_en_s1_agent_rdata_fifo_src_data;                                         // LCD_EN_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         lcd_en_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_001:in_0_ready -> LCD_EN_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                           // avalon_st_adapter_001:out_0_valid -> LCD_EN_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                            // avalon_st_adapter_001:out_0_data -> LCD_EN_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                           // LCD_EN_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                           // avalon_st_adapter_001:out_0_error -> LCD_EN_s1_agent:rdata_fifo_sink_error
	wire         lcd_rw_s1_agent_rdata_fifo_src_valid;                                        // LCD_RW_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] lcd_rw_s1_agent_rdata_fifo_src_data;                                         // LCD_RW_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         lcd_rw_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_002:in_0_ready -> LCD_RW_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                           // avalon_st_adapter_002:out_0_valid -> LCD_RW_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                            // avalon_st_adapter_002:out_0_data -> LCD_RW_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                           // LCD_RW_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                           // avalon_st_adapter_002:out_0_error -> LCD_RW_s1_agent:rdata_fifo_sink_error
	wire         lcd_rs_s1_agent_rdata_fifo_src_valid;                                        // LCD_RS_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] lcd_rs_s1_agent_rdata_fifo_src_data;                                         // LCD_RS_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         lcd_rs_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_003:in_0_ready -> LCD_RS_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                           // avalon_st_adapter_003:out_0_valid -> LCD_RS_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                            // avalon_st_adapter_003:out_0_data -> LCD_RS_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                           // LCD_RS_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                           // avalon_st_adapter_003:out_0_error -> LCD_RS_s1_agent:rdata_fifo_sink_error
	wire         lcd_data_s1_agent_rdata_fifo_src_valid;                                      // LCD_DATA_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] lcd_data_s1_agent_rdata_fifo_src_data;                                       // LCD_DATA_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         lcd_data_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_004:in_0_ready -> LCD_DATA_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                           // avalon_st_adapter_004:out_0_valid -> LCD_DATA_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                            // avalon_st_adapter_004:out_0_data -> LCD_DATA_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                           // LCD_DATA_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                           // avalon_st_adapter_004:out_0_error -> LCD_DATA_s1_agent:rdata_fifo_sink_error
	...
	wire         memory_s1_agent_rdata_fifo_src_valid;                                        // memory_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] memory_s1_agent_rdata_fifo_src_data;                                         // memory_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         memory_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_007:in_0_ready -> memory_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                           // avalon_st_adapter_007:out_0_valid -> memory_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                            // avalon_st_adapter_007:out_0_data -> memory_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                           // memory_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                           // avalon_st_adapter_007:out_0_error -> memory_s1_agent:rdata_fifo_sink_error
